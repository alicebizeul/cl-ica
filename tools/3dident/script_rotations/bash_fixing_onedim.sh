...
do
    ...
    DATA_NAME="mydata_fixing_rotation_onedim"
    ...
    #if [[ $j -eq 0 ]] 
    #then
    #    python generate_clevr_dataset_latents.py --output-folder ${DIR_DATA} --n-points ${N_POINTS} --non-periodic-rotation-and-color --deterministic --debug2
    #fi
