#!/bin/bash 
#SBATCH -o /cluster/work/vogtlab/Group/abizeul/multimodal_texture_rotations_causal.out
...
DATA_NAME="mydata_rotations_causal/3dident/train"  # include mention to test/val/train, MS and C/S settings
DIR_DATA="/cluster/work/vogtlab/Group/abizeul/$DATA_NAME"
DIR_ZIP="/cluster/work/vogtlab/Group/abizeul/"
...
#python generate_clevr_dataset_latents_causal.py --output-folder ${DIR_DATA} --n-points ${N_POINTS} --non-periodic-rotation-and-color --deterministic --all-rotations --multimodal
