#!/bin/bash 
#SBATCH -o /cluster/work/vogtlab/Group/abizeul/multimodal_texture_rotations_train_causal.out
...
DIR_DATA="/cluster/work/vogtlab/Group/abizeul/mydata_rotations_train_causal"

python generate_clevr_dataset_latents_causal.py --output-folder ${DIR_DATA} --n-points 250000 --non-periodic-rotation-and-color --deterministic --all-rotations --multimodal 
...
scp "$DIR_DATA.zip" "/cluster/work/vogtlab/Group/abizeul/3DIdent/mydata_multimodal_texture_rotations_train_causal.zip"
