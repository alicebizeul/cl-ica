#!/bin/bash 
#SBATCH -o /cluster/work/vogtlab/Group/abizeul/multimodal_texture_rotations_val_causal.out
...
DIR_DATA="/cluster/work/vogtlab/Group/abizeul/mydata_rotations_val_causal"
...
scp "$DIR_DATA.zip" "/cluster/work/vogtlab/Group/abizeul/3DIdent/mydata_multimodal_texture_rotations_val_causal.zip"
