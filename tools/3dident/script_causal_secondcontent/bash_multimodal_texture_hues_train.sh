#!/bin/bash 
#SBATCH -o /cluster/work/vogtlab/Group/abizeul/multimodal_texture_hues_causal.out
...
DATA_NAME="mydata_hues_causal/3dident/train"  # include mention to test/val/train, MS and C/S settings
