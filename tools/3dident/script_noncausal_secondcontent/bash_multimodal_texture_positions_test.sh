#BSUB -oo /cluster/work/vogtlab/Group/abizeul/multimodal_texture_positions_test.out
#BSUB -W 4:00
#BSUB -n 4
...
python generate_clevr_dataset_latents.py --output-folder "$TMPDIR/mydata" --n-points 10000 --non-periodic-rotation-and-color --deterministic --all-positions --multimodal
...
scp "$TMPDIR/mydata.zip" "/cluster/work/vogtlab/Group/abizeul/3DIdent/mydata_multimodal_texture_position_test.zip"
