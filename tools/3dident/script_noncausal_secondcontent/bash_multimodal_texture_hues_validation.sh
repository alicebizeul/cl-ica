#BSUB -oo /cluster/work/vogtlab/Group/abizeul/multimodal_texture_hues_val.out
#BSUB -W 4:00
#BSUB -n 4
...
scp "$TMPDIR/mydata.zip" "/cluster/work/vogtlab/Group/abizeul/3DIdent/mydata_multimodal_texture_hues_val.zip"
