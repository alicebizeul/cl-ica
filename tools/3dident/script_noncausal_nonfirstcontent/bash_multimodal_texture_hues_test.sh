...
DATA_NAME="mydata_hues_test"  # include mention to test/val/train, MS and C/S settings
DIR_DATA="/cluster/work/vogtlab/Group/abizeul/$DATA_NAME"
DIR_ZIP="/cluster/work/vogtlab/Group/abizeul/3DIdent/"
N_POINTS=10  # if test/validation fix this to 10 000, for train fix this to 250 000
#####################################################################
