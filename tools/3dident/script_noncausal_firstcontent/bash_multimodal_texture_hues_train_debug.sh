#BSUB -oo /cluster/work/grlab/projects/projects2022-identifiability/multimodal_texture_hues_train_debug.out
#BSUB -W 50:00
#BSUB -n 4
#BSUB -R "rusage[ngpus_excl_p=1,mem=10000,scratch=30000]"
...
python generate_clevr_dataset_latents.py --output-folder "$TMPDIR/mydata" --n-points 150000 --non-periodic-rotation-and-color --deterministic --debug 
...
scp "$TMPDIR/mydata.zip" "/cluster/work/grlab/projects/projects2022-identifiability/mydata_multimodal_texture_hues_train_firstcontent_debug.zip"
