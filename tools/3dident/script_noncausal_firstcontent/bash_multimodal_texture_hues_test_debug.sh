#BSUB -oo /cluster/work/grlab/projects/projects2022-identifiability/multimodal_texture_hues_test_debug.out
#BSUB -W 5:00
#BSUB -n 4
...
python generate_clevr_dataset_latents.py --output-folder "$TMPDIR/mydata" --n-points 10000 --non-periodic-rotation-and-color --deterministic --debug 
...
scp "$TMPDIR/mydata.zip" "/cluster/work/grlab/projects/projects2022-identifiability/mydata_multimodal_texture_hues_test_firstcontent_debug.zip"
