#BSUB -oo /cluster/work/grlab/projects/projects2022-identifiability/multimodal_texture_hues_val_debug.out
#BSUB -W 5:00
#BSUB -n 4
...
scp "$TMPDIR/mydata.zip" "/cluster/work/grlab/projects/projects2022-identifiability/mydata_multimodal_texture_hues_val_firstcontent_debug.zip"
