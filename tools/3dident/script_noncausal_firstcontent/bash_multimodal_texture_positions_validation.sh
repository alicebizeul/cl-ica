#BSUB -oo /cluster/work/grlab/projects/projects2022-identifiability/multimodal_texture_positions_val.out
#BSUB -W 4:00
#BSUB -n 4
...
scp "$TMPDIR/mydata.zip" "/cluster/work/grlab/projects/projects2022-identifiability/mydata_multimodal_texture_position_val_firstcontent.zip"
