#!/bin/bash 
#SBATCH -o /cluster/work/vogtlab/Group/abizeul/multimodal_texture_positions_val_firstcontent.out
#SBATCH --time=4:00:00
#SBATCH -p gpu
...
DATA_NAME="mydata_positions_val_firstcontent"  # include mention to test/val/train, MS and C/S settings
