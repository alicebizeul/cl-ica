...
DATA_NAME="mydata_hues_test_firstcontent"  # include mention to test/val/train, MS and C/S settings
...
python generate_clevr_dataset_latents.py --output-folder ${DIR_DATA} --n-points ${N_POINTS} --non-periodic-rotation-and-color --deterministic --all-hues --multimodal --first_content
