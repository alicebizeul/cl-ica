#BSUB -oo /cluster/work/grlab/projects/projects2022-identifiability/multimodal_texture_hues_val.out
#BSUB -W 4:00
#BSUB -n 4
...
python generate_clevr_dataset_latents.py --output-folder "$TMPDIR/mydata" --n-points 10000 --non-periodic-rotation-and-color --deterministic --all-hues --multimodal --first_content 
...
scp "$TMPDIR/mydata.zip" "/cluster/work/grlab/projects/projects2022-identifiability/mydata_multimodal_texture_hues_val_firstcontent.zip"
