#!/bin/bash 
#SBATCH -o /cluster/work/grlab/projects/projects2022-identifiability/multimodal_texture_rotations_test_causal.out
#SBATCH --time=4:00:00
#SBATCH -p gpu
...
DATA_NAME="mydata_rotations_test_causal"  # include mention to test/val/train, MS and C/S settings
