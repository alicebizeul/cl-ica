#!/bin/bash 
#SBATCH -o /cluster/work/grlab/projects/projects2022-identifiability/multimodal_texture_positions_test_causal.out
#SBATCH --time=4:00:00
#SBATCH -p gpu
...
DATA_NAME="mydata_positions_test_causal"  # include mention to test/val/train, MS and C/S settings
...
python generate_clevr_dataset_latents_causal.py --output-folder ${DIR_DATA} --n-points ${N_POINTS} --non-periodic-rotation-and-color --deterministic --all-positions --multimodal
