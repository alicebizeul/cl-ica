#!/bin/bash 
#SBATCH -o /cluster/work/vogtlab/Group/abizeul/multimodal_texture_positions_test_causal.out
...
DIR_DATA="/cluster/work/vogtlab/Group/abizeul/mydata_positions_test_causal"

python generate_clevr_dataset_latents_causal.py --output-folder ${DIR_DATA} --n-points 10000 --non-periodic-rotation-and-color --deterministic --all-positions --multimodal
...
scp "$DIR_DATA.zip" "/cluster/work/vogtlab/Group/abizeul/3DIdent/mydata_multimodal_texture_positions_test_causal.zip"
