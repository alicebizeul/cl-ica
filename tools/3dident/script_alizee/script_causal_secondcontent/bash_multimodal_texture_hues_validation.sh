...
DIR_DATA="/cluster/work/vogtlab/Group/abizeul/mydata_hues_val_causal"
...
scp "$DIR_DATA.zip" "/cluster/work/vogtlab/Group/abizeul/3DIdent/mydata_multimodal_texture_hues_val_causal.zip"
