#!/bin/bash 
#BSUB -o "generation_positions_firstcontent.out"
#BSUB -W 30:00
#BSUB -J generation_positions_firstcontent
#BSUB -n 4
...
DATA_NAME="mydata_multimodal_texture_positions_firstcontent/3dident/train"  # include mention to test/val/train, MS and C/S settings
